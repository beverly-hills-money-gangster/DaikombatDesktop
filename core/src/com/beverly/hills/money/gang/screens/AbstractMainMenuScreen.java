...
public abstract class AbstractMainMenuScreen extends GameScreen {
    ...
    private final String networkClientVersion = ("Network client ver: " + ClientConfig.VERSION).toUpperCase(Locale.ENGLISH);
    ...
    public void render(final float delta) {
        ...
        getGame().getBatch().draw(skyBg, 0, 0, getViewport().getWorldWidth(), getViewport().getWorldHeight());
        ...
        guiFont32.draw(getGame().getBatch(), networkClientVersion, getViewport().getWorldWidth() / 2f - glyphLayoutNetworkClient.width / 2f,
