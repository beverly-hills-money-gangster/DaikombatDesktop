...
import com.beverly.hills.money.gang.entities.projectile.EnemyPlasmaProjectile;
import com.beverly.hills.money.gang.entities.projectile.Projectile;

public class EnemyPlasmaProjectileShootFactory implements EnemyProjectileShootFactory {


  @Override
  public Projectile create(Vector2 position, Vector2 direction,
      Player player) {
    return new EnemyPlasmaProjectile(
