...
public class EnemyTextures {
    ...
    private static final EnemyTextureRegistry[] BACK_THREE_STEP = {EnemyTextureRegistry.MOVING1TEXBACKREG, EnemyTextureRegistry.MOVING2TEXBACKREG, EnemyTextureRegistry.MOVING3TEXBACKREG};
    private static final EnemyTextureRegistry[] LEFT_THREE_STEP = {EnemyTextureRegistry.MOVING1TEXLEFTREG, EnemyTextureRegistry.MOVING2TEXLEFTREG, EnemyTextureRegistry.MOVING3TEXLEFTREG};
    private static final EnemyTextureRegistry[] RIGHT_THREE_STEP = {EnemyTextureRegistry.MOVING1TEXRIGHTREG, EnemyTextureRegistry.MOVING2TEXRIGHTREG, EnemyTextureRegistry.MOVING3TEXRIGHTREG};
    ...
    public EnemyTextures(DaiKombatAssetsManager assetsManager, int enemyId) {
        ...
        for (EnemyTextureRegistry enemyTextureRegistry : EnemyTextureRegistry.values()) {
            if (!textures.containsKey(enemyTextureRegistry)) {
                throw new IllegalStateException("Texture " + enemyTextureRegistry.toString() + " is not loaded");
            }
        }
    }
