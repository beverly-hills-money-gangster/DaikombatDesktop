...
//	DOOR
        final TextureRegion texRegDoorNorth = game.getAssMan().getTextureRegion(TexturesRegistry.ATLAS, 96, 48, -16, 16);
        final TextureRegion texRegDoorSouth = game.getAssMan().getTextureRegion(TexturesRegistry.ATLAS, 80, 48, 16, 16);
        final TextureRegion texRegDoorMiddle = game.getAssMan().getTextureRegion(TexturesRegistry.ATLAS, 100, 48, -4, 16);
