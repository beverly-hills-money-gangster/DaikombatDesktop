...
public class Cell3D extends Entity {
  ...
  public void render3D(final ModelBatch mdlBatch, final Environment env, final float delta) {
    if (hasWallNorth) {
      mdlInstWallNorth.setInFrustum(
          getScreen().frustumCull(getScreen().getCurrentCam(), mdlInstWallNorth));
    ...
    if (hasWallSouth) {
      mdlInstWallSouth.setInFrustum(
          getScreen().frustumCull(getScreen().getCurrentCam(), mdlInstWallSouth));
    ...
    if (hasWallWest) {
      mdlInstWallWest.setInFrustum(
          getScreen().frustumCull(getScreen().getCurrentCam(), mdlInstWallWest));
    ...
    if (hasWallEast) {
      mdlInstWallEast.setInFrustum(
          getScreen().frustumCull(getScreen().getCurrentCam(), mdlInstWallEast));
    ...
    if (hasCeiling) {
      mdlInstCeiling.setInFrustum(
          getScreen().frustumCull(getScreen().getCurrentCam(), mdlInstCeiling));
