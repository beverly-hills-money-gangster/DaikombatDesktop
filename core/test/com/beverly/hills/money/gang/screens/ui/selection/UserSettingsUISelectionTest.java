...
public class UserSettingsUISelectionTest {
    ...
    public void testNormalizeAfterIncrease() {
        ...
        assertEquals(
                (UserSettingsUISelection.SettingState.DEFAULT + UserSettingsUISelection.SettingState.SETTING_DELTA) / 10D,
                UserSettingsUISelection.SOUND.getState().getNormalized(), 0.00001);
    }
    ...
    public void testIncrease() {
        UserSettingsUISelection.SOUND.getState().increase();
        assertEquals(
                UserSettingsUISelection.SettingState.DEFAULT + UserSettingsUISelection.SettingState.SETTING_DELTA,
